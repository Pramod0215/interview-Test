...
import Backgrouand from './assets/img/why-us.png'
                        ...
                        <div class="container">
                            ...
                            <div class="row" data-aos="zoom-in">
                                ...
                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-1.png")} class="img-fluid" alt="" />
                                </div>

                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-2.png")} class="img-fluid" alt="" />
                                </div>

                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-3.png")} class="img-fluid" alt="" />
                                </div>

                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-4.png")} class="img-fluid" alt="" />
                                </div>

                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-5.png")} class="img-fluid" alt="" />
                                </div>

                                <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                    <img src={require("./assets/img/clients/client-6.png")} class="img-fluid" alt="" />
                                </div>
                    ...
                    <section id="why-us" class="why-us section-bg">
                        <div class="container-fluid" data-aos="fade-up">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style={{ backgroundImage: "url(" + { Backgrouand } + ")" }} data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
                            </div>
                        ...
                        <div class="container" data-aos="fade-up">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                                    <img src={require("./assets/img/skills.png")} class="img-fluid" alt="" />
                                </div>
                        ...
                        <div class="container" data-aos="fade-up">
                            ...
                            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-2.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>Web 3</h4>
                                        <p>Web</p>
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-3.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>App 2</h4>
                                        <p>App</p>
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-4.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>Card 2</h4>
                                        <p>Card</p>
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-7.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>Card 1</h4>
                                        <p>Card</p>
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-8.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>Card 3</h4>
                                        <p>Card</p>
                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                    <div class="portfolio-img"><img src={require("./assets/img/portfolio/portfolio-9.jpg")} class="img-fluid" alt="" /></div>
                                    <div class="portfolio-info">
                                        <h4>Web 3</h4>
                                        <p>Web</p>
